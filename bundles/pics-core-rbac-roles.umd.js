(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var RolesComponent = /** @class */ (function () {
        function RolesComponent(injector, formBuilder, alertService, mstrService, rolesService, _storeservice) {
            var _this = this;
            ...
            this.orgSubs = this._storeservice.currentStore.subscribe(function (res) {
                if (res['RBACORG'] && res['RBACORG'] !== '') {
                    ...
                    _this.getReportDashboard();
                    _this.httpService = res['HTTPSERVICE'];
                    if (_this.orgId) {
                        _this.getRoleList();
                        _this.getPolicyGroupList();
                        _this.getLandingPage();
                    }
                }
            });
        }
        ...
        RolesComponent.prototype.initializeform = function () {
            this.roleForm = this.formBuilder.group({
                ...
                parentid: [2],
                policyGroupId: [0, i1$2.Validators.required],
                dossierid: ['', i1$2.Validators.required]
            });
        };
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: RolesComponent, decorators: [{
            ...
            }], ctorParameters: function () { return [{ type: i0__namespace.Injector }, { type: i1__namespace$2.FormBuilder }, { type: AlertService }, { type: MicrostrategyService }, { type: RbacService }, { type: DataStoreService }]; } });
    ...
    PicsRbacRolesModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: PicsRbacRolesModule, declarations: [RolesComponent], imports: [i12.CommonModule,
    ...
    PicsRbacRolesModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: PicsRbacRolesModule, providers: [RbacService, MicrostrategyService, i1$1.HttpClient, AlertService, i15.ConfirmationService, PermissionStore, DataStoreService], imports: [[
                i12.CommonModule,
                i1$2.ReactiveFormsModule,
                ngBootstrap.NgbModule,
                tabmenu.TabMenuModule,
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: PicsRbacRolesModule, decorators: [{
                ...
                args: [{
                        ...
                        providers: [RbacService, MicrostrategyService, i1$1.HttpClient, AlertService, i15.ConfirmationService, PermissionStore, DataStoreService]
                    }]
            }] });
